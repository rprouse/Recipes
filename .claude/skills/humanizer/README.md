...
A Claude Code skill that removes signs of AI-generated writing from text, making it sound more natural and human. This skill was originally from [agent-toolkit](https://github.com/softaworks/agent-toolkit) under the MIT license.
